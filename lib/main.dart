...
import 'package:tugas_akhir_app/ui/pages/main_page/home_page/fitur_page/bengkel_prostetik_page.dart';
...
import 'package:tugas_akhir_app/ui/pages/main_page/profile_page/profile_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/bengkelprostetik' :(context) => const BengkelProstetikPage(),

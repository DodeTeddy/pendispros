                                  ...
                                  Expanded(
                                    child: Column(
                                      children: [
                                        ...
                                        Visibility(
                                          visible:
                                              profileData.verifiedAs != 'admin',
                                          child: ProfileItem(
                                              icon: Icons.call,
                                              text: profileData.phone.isEmpty
                                                  ? '-'
                                                  : profileData.phone),
                                        ),
                                        const SizedBox(height: 10),
                                        ProfileItem(
                                          icon: Icons.verified,
                                          text: profileData.verifiedAs ==
                                                  'disability'
                                              ? 'Terverifikasi Disabilitas'
                                              : profileData.verifiedAs ==
                                                      'prosthetic'
                                                  ? 'Terverifikasi Bengkel Prostetik'
                                                  : profileData.verifiedAs ==
                                                          'admin'
                                                      ? 'Admin'
                                                      : 'Belum Terverifikasi',
                                          textColor: profileData.verifiedAs ==
                                                      'disability' ||
                                                  profileData.verifiedAs ==
                                                      'prosthetic'
                                              ? primaryColor

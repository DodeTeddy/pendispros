...
class _CreateInformationPageState extends State<CreateInformationPage> {
  ...
  void addData()async{
    if (titleController.text.isEmpty || detailController.text.isEmpty) {
      ...
      CreateInformationModel createInformationModel = await createInformation(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              IconButton(
                                onPressed: () {
                                  titleEditController.text = information[index].titleInformation;
                                  detailEditController.text = information[index].detailInformation;
                                  QuickAlert.show(
                                    title: '',
                                    context: context,
                                    ...
                                    onConfirmBtnTap: () => updateData(information[index].id),
                                    cancelBtnText: 'Tidak',
                              ...
                              IconButton(
                                onPressed: () => QuickAlert.show(
                                  ...
                                  type: QuickAlertType.confirm,
                                  confirmBtnText: 'Ya',
                                  onConfirmBtnTap: () => deleteData(information[index].id),
                                  cancelBtnText: 'Tidak',
                                  confirmBtnColor: primaryColor,
                                  customAsset: 'assets/images/get_started.png',
                                  backgroundColor: secondaryColor
